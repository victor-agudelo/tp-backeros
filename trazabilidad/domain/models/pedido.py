...
class Pedido(BaseModel):
    ...
    pedidoRealizadoTimestamp: datetime = Field(..., example="2025-01-09T08:23:42")
    empleadoAsignado: Optional[str] = Field(default=None, example="Homero Simpson")
    pedidoEnPreparacionTimestamp: Optional[datetime] = Field(default=None, example="2025-01-09T08:23:42")
    pedidoListoTimestamp: Optional[datetime] = Field(default=None, example="2025-01-09T08:23:42")
